...
namespace MyPersonalBlog.Tests
{
    ...
    public class AdminCommentTests
    {
        ...
        public void Can_Get_Comment_By_Id()
        {
            ...
            mock.Setup(m => m.GetById(It.IsAny<int>())).Returns((int id) => _comments.Where(c => c.Id == id).SingleOrDefault());

            // Организация - создание контроллера
            CommentsController target = new CommentsController(mock.Object);
        ...
        public void Can_Get_All_Not_Approved_Comments()
        {
            ...
            mock.Setup(m => m.Comments).Returns(_comments.OrderByDescending(c => c.CreateDate));

            // Организация - создание контроллера
            CommentsController target = new CommentsController(mock.Object);
            target.PageSize = _comments.Count;

            // Действие - получаем неопубликованные комментарии
            var result = (IEnumerable<Comment>)target.List(null, null, "hide").Model;
        ...
        public void Can_Paginate()
        {
            ...
            mock.Setup(m => m.Comments).Returns(_comments);
            ...
            var result = (IEnumerable<Comment>)target.List(2, null, null).Model;
