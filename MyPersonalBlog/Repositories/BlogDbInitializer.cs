...
namespace MyPersonalBlog.Repositories
{
    public class BlogDbInitializer : DropCreateDatabaseAlways<BlogContext>
    {
        protected override void Seed(BlogContext db)
        {
            ...
            testPosts.Add(new Post { Id = 2, Title = "Test blog post #2", IntroText = "Intro Text", MainText = "Main Text", CreateDate = DateTime.Now.AddMinutes(1), Published = true });
            testPosts.Add(new Post { Id = 3, Title = "Test blog post #3", IntroText = "Intro Text", MainText = "Main Text", CreateDate = DateTime.Now.AddMinutes(2), Published = true });
            testPosts.Add(new Post { Id = 4, Title = "Test blog post #4", IntroText = "Intro Text", MainText = "Main Text", CreateDate = DateTime.Now.AddMinutes(3), Published = false });
            testPosts.Add(new Post { Id = 5, Title = "Test blog post #5", IntroText = "Intro Text", MainText = "Main Text", CreateDate = DateTime.Now.AddMinutes(4), Published = true });
            testPosts.Add(new Post { Id = 6, Title = "Test blog post #6", IntroText = "Intro Text", MainText = "Main Text", CreateDate = DateTime.Now.AddMinutes(5), Published = true });
            testPosts.Add(new Post { Id = 7, Title = "Test blog post #7", IntroText = "Intro Text", MainText = "Main Text", CreateDate = DateTime.Now.AddMinutes(6), Published = false });
            testPosts.Add(new Post { Id = 8, Title = "Test blog post #8", IntroText = "Intro Text", MainText = "Main Text", CreateDate = DateTime.Now.AddMinutes(7), Published = true });
            testPosts.Add(new Post { Id = 9, Title = "Test blog post #9", IntroText = "Intro Text", MainText = "Main Text", CreateDate = DateTime.Now.AddMinutes(8), Published = true });

            testPosts[0].Title = "Lorem ipsum";
